...
export default function RulesPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#FDFBF7] text-[#1A1A1A] font-mono selection:bg-[#1A1A1A]/10 selection:text-black">
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 md:py-32 w-full">
        <div className="space-y-16">
          ...
          >
            ...
            <div className="rounded-2xl border border-[#EBE6DF] bg-[#FDFBF7] shadow-sm overflow-hidden">
              <ul className="divide-y divide-[#EBE6DF]">
                {[
                  { id: "2.1", text: "All contributions must be made to the repositories listed by NST-SDC for this event. PRs to repositories outside the provided list will not be counted." },
          ...
          >
            ...
            <div className="rounded-2xl border border-[#EBE6DF] bg-[#FDFBF7] shadow-sm overflow-hidden">
              <div className="flex items-start gap-4 px-6 py-5 border-b border-[#EBE6DF]">
                ...
                <p className="text-sm text-[#6B6661] leading-relaxed">Points are assigned per merged PR based on the difficulty label of the resolved issue:</p>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-[#F5F2EA] border-b border-[#EBE6DF]">
                      <th className="px-8 py-5 text-xs font-black text-[#8C867E] uppercase tracking-widest">Difficulty</th>
                      <th className="px-8 py-5 text-xs font-black text-[#8C867E] uppercase tracking-widest">Base Points</th>
                      <th className="px-8 py-5 text-xs font-black text-[#8C867E] uppercase tracking-widest">Description</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#EBE6DF]">
                    <tr className="hover:bg-[#F5F2EA] transition-colors">
                      <td className="px-8 py-5">
                        <span className="inline-block px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase border border-[#EBE6DF] text-[#8C867E]">Extreme</span>
                      </td>
                      <td className="px-8 py-5 text-sm font-bold text-[#1A1A1A]">100 Pts</td>
                      <td className="px-8 py-5 text-sm text-[#6B6661]">Major system-level contributions, critical bug fixes, significant new functionality</td>
                    </tr>
                    <tr className="hover:bg-[#F5F2EA] transition-colors">
                      <td className="px-8 py-5">
                        <span className="inline-block px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase border border-[#EBE6DF] text-[#8C867E]">Hard</span>
                      </td>
                      <td className="px-8 py-5 text-sm font-bold text-[#1A1A1A]">80 Pts</td>
                      <td className="px-8 py-5 text-sm text-[#6B6661]">Complex features, architecture changes, performance work</td>
                    </tr>
                    <tr className="hover:bg-[#F5F2EA] transition-colors">
                      <td className="px-8 py-5">
                        <span className="inline-block px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase border border-[#EBE6DF] text-[#8C867E]">Medium</span>
                      </td>
                      <td className="px-8 py-5 text-sm font-bold text-[#1A1A1A]">60 Pts</td>
                      <td className="px-8 py-5 text-sm text-[#6B6661]">Feature additions, moderate refactors, test coverage</td>
                    </tr>
                    <tr className="hover:bg-[#F5F2EA] transition-colors">
                      <td className="px-8 py-5">
                        <span className="inline-block px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase border border-[#EBE6DF] text-[#8C867E]">Easy</span>
                      </td>
                      <td className="px-8 py-5 text-sm font-bold text-[#1A1A1A]">40 Pts</td>
                      <td className="px-8 py-5 text-sm text-[#6B6661]">Bug fixes, minor UI changes, small documentation improvements</td>
                    </tr>
                    <tr className="hover:bg-[#F5F2EA] transition-colors">
                      <td className="px-8 py-5">
                        <span className="inline-block px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase border border-[#EBE6DF] text-[#8C867E]">Beginner Friendly</span>
                      </td>
                      <td className="px-8 py-5 text-sm font-bold text-[#1A1A1A]">20 Pts</td>
                      <td className="px-8 py-5 text-sm text-[#6B6661]">First-time contributions, typo fixes, minor documentation updates</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="rounded-2xl border border-[#EBE6DF] bg-[#FDFBF7] shadow-sm overflow-hidden">
              <ul className="divide-y divide-[#EBE6DF]">
                {[
                  { id: "3.2", text: "Maintainers may award bonus points for exceptional PR quality — clean code, thorough testing, clear documentation, or going beyond the issue scope. Bonus values are at maintainer discretion." },
                  { id: "3.3", text: "In the event of a tie, the contributor with the higher number of merged PRs ranks higher. If still tied, the contributor who reached the score first (by merge timestamp) ranks higher." },
                ].map((rule) => (
                  <li key={rule.id} className="flex items-start gap-4 px-6 py-5 hover:bg-[#F5F2EA] transition-colors">
                    <span className="text-xs font-black text-[#8C867E] tracking-widest mt-0.5 flex-shrink-0">{rule.id}</span>
                    <p className="text-sm text-[#6B6661] leading-relaxed">{rule.text}</p>
